...
export function HeroSection() {
  return (
    <section
      id="main"
      className="relative min-h-svh overflow-hidden px-5 pb-0 pt-28 sm:px-8 lg:pt-32"
    >

      {/* Hero portrait — desktop */}
      <div
        aria-hidden="true"
        className="absolute top-16 right-[6%] lg:right-[8%] xl:right-[12%] z-10 hidden lg:block pointer-events-none"
        style={{ width: 300, height: 500 }}
      >
        <Image
          src="/chanchal-removebg-preview.png"
          alt=""
          fill
          priority
          sizes="380px"
          ...
          style={{
            maskImage:
              "linear-gradient(to bottom, black 0%, black 60%, rgba(0,0,0,0.4) 85%, transparent 100%)",
            WebkitMaskImage:
              "linear-gradient(to bottom, black 0%, black 60%, rgba(0,0,0,0.4) 85%, transparent 100%)",
          }}
        />
      ...
      <div className="container-shell flex min-h-[74svh] flex-col justify-between gap-10">
        <div className="max-w-160 pt-8 sm:pt-12 lg:pt-16">
          ...
          {/* Mobile portrait */}
          <div className="fade-up delay-4 relative mt-9 h-44 overflow-hidden rounded-2xl sm:h-52 lg:hidden">
            <Image
              src="/chanchal-removebg-preview.png"
